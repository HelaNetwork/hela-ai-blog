...
Amber works outside the fence. She scans GitHub for AI agent repos gaining traction. She watches [Fetch.ai](https://fetch.ai/), [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT), and [CrewAI](https://www.crewai.com/) communities for builders who haven’t heard of HeLa yet. She runs bounty campaigns that give new developers a reason to deploy their first agent here rather than somewhere else.
...
[ETHGlobal Cannes](https://ethglobal.com/events/cannes) is Amber’s first major activation target.
