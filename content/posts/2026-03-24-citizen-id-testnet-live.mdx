...
1. **Get testnet HLUSD.** Visit the [HeLa Testnet Faucet](https://faucet.helachain.com) and request tokens for chain ID 666888.
...
Details and submission guidelines: [HeLa Bug Bounty on GitHub](https://github.com/hela-chain/bug-bounty)
...
*Found a bug? Submit it to the [bug bounty program](https://github.com/hela-chain/bug-bounty). Built something on Citizen ID? Tell us in the [community channels](https://t.me/helachain).*
