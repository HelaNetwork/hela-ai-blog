...
HeLa's bet is that accountability built into the architecture — agents with verifiable on-chain identity and traceable decisions — is more durable than accountability bolted on after the fact. Seth is that bet in practice.
