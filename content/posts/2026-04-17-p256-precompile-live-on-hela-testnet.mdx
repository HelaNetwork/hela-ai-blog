...
There's a subtlety worth calling out. The popular version of this precompile is RIP-7212, which is deployed on Polygon, Optimism, Arbitrum, Base, and most other EVM chains. HeLa runs **EIP-7951's** validation logic -- the security-hardened successor. Shipped to Ethereum L1 in the [Fusaka upgrade](https://www.alchemy.com/blog/ethereum-fusaka-upgrade-dev-guide-to-12-eips) (December 2025) as [EIP-7951](https://eips.ethereum.org/EIPS/eip-7951) at 6,900 gas — the security-hardened successor to RIP-7212.
