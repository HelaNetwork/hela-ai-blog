...
**Compiler:** [Solidity 0.8.24](https://soliditylang.org/blog/2024/01/26/solidity-0.8.24-release-announcement/) (pragma `^0.8.24`, source: `src/citizen/HeLaCitizenNFT.sol`)
**EVM Target:** `paris` (`hardhat.config.ts` `evmVersion`)
**Dependencies:** [OpenZeppelin Contracts Upgradeable v5.0.2](https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/releases/tag/v5.0.2)
**Standard:** [ERC-6551 reference registry](https://eips.ethereum.org/EIPS/eip-6551) for token-bound accounts
