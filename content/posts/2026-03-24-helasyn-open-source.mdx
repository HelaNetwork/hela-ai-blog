...
This is the [LangChain](https://www.langchain.com/) model applied to a blockchain. LangChain gave away the orchestration framework and built a company around the tooling ecosystem. We're doing the same, except the ecosystem is a chain — and chains have native economics.
