...
The same precompile (RIP-7212 / EIP-7951) is already live on Polygon, Optimism, Arbitrum, Base, zkSync, Sei, and Scroll with zero incidents. Shipped to Ethereum L1 in the [Fusaka upgrade](https://www.alchemy.com/blog/ethereum-fusaka-upgrade-dev-guide-to-12-eips) (Nov 2025) as [EIP-7951](https://eips.ethereum.org/EIPS/eip-7951) at 6,900 gas. We are bringing HeLa in line with the industry standard.
